...
5. 新增功能：添加自动刷新功能，可设置刷新间隔时间，自动获取最新商品
6. 优化功能：设置默认排序为"最新发布"，优先显示最新上架商品
7. 优化功能：改进"只看关注的人"选项的显示样式
8. 优化搜索功能：高级搜索现在调用普通搜索函数，确保功能一致性并提高代码复用性
9. 改进UI展示：卡片视图和表格视图都支持显示更详细的商品信息，不同类型标签采用不同颜色区分
